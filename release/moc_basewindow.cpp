...
#include "../src/widgets/basewindow.h"
...
namespace {
struct qt_meta_tag_ZN10BaseWindowE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN10BaseWindowE = QtMocHelpers::stringData(
    "BaseWindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10BaseWindowE[] = {
...
Q_CONSTINIT const QMetaObject BaseWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10BaseWindowE.offsetsAndSizes,
    qt_meta_data_ZN10BaseWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10BaseWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *BaseWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10BaseWindowE.stringdata0))
