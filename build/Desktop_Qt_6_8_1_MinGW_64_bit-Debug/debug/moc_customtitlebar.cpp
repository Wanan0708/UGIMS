...
#include "../../../src/widgets/customtitlebar.h"
...
static constexpr auto qt_meta_stringdata_ZN14CustomTitleBarE = QtMocHelpers::stringData(
    "CustomTitleBar",
    "onClose",
    "",
    "onMinimize",
...
Q_CONSTINIT static const uint qt_meta_data_ZN14CustomTitleBarE[] = {
...
Q_CONSTINIT const QMetaObject CustomTitleBar::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14CustomTitleBarE.offsetsAndSizes,
    qt_meta_data_ZN14CustomTitleBarE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14CustomTitleBarE_t,
        // Q_OBJECT / Q_GADGET
...
void CustomTitleBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->onMaximizeRestore(); break;
        default: ;
        }
    }
    (void)_a;
...
void *CustomTitleBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14CustomTitleBarE.stringdata0))
